...
const PinDescription g_APinDescription[]=
{
  ...
  { EPORT_B, 4, PIO_MUX_0, (PIN_ATTR_DIGITAL), TIMER_4, EXTERNAL_INT_NONE },
  { EPORT_B, 3, PIO_MUX_0, (PIN_ATTR_DIGITAL), TIMER_5, EXTERNAL_INT_NONE },
  { EPORT_B, 2, PIO_MUX_0, (PIN_ATTR_DIGITAL), TIMER_6, EXTERNAL_INT_NONE },
  { EPORT_B, 1, PIO_MUX_0, (PIN_ATTR_DIGITAL), NOT_ON_TIMER, EXTERNAL_INT_NONE },
  { EPORT_B, 0, PIO_MUX_0, (PIN_ATTR_DIGITAL), NOT_ON_TIMER, EXTERNAL_INT_NONE },
  { EPORT_A, 11, PIO_MUX_0, (PIN_ATTR_DIGITAL), NOT_ON_TIMER, EXTERNAL_INT_NONE },

  { EPORT_A, 10, PIO_MUX_0, (PIN_ATTR_DIGITAL), NOT_ON_TIMER, EXTERNAL_INT_NONE },
  { EPORT_A, 9, PIO_MUX_0, (PIN_ATTR_DIGITAL), NOT_ON_TIMER, EXTERNAL_INT_NONE },
  { EPORT_A, 8, PIO_MUX_0, (PIN_ATTR_DIGITAL), NOT_ON_TIMER, EXTERNAL_INT_NONE },
  { EPORT_A, 7, PIO_MUX_0, (PIN_ATTR_DIGITAL), NOT_ON_TIMER, EXTERNAL_INT_NONE },
  { EPORT_A, 5, PIO_MUX_0, (PIN_ATTR_DIGITAL), NOT_ON_TIMER, EXTERNAL_INT_NONE },

  //13 LED
  { EPORT_A, 4, PIO_MUX_0, (PIN_ATTR_DIGITAL), NOT_ON_TIMER, EXTERNAL_INT_NONE },
  ...
  //22..25 I2C
  { EPORT_C, 5, PIO_MUX_0, (PIN_ATTR_DIGITAL), NOT_ON_TIMER, EXTERNAL_INT_NONE }, // SPORT0_AFS
  { EPORT_C, 6, PIO_MUX_0, (PIN_ATTR_DIGITAL), NOT_ON_TIMER, EXTERNAL_INT_NONE }, // SPORT0_BD0
  { EPORT_C, 8, PIO_MUX_0, (PIN_ATTR_DIGITAL), NOT_ON_TIMER, EXTERNAL_INT_NONE }, // SPORT0_AD0
  { EPORT_C, 9, PIO_MUX_0, (PIN_ATTR_DIGITAL), NOT_ON_TIMER, EXTERNAL_INT_NONE }, // SPORT0_ACLK
};
